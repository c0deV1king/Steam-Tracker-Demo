    ...
    <div className="min-h-screen flex items-center justify-center">
      <div className="bg-base-100 p-8 rounded-lg shadow-lg w-96 border border-black">
        <h1 className="text-3xl mb-6 text-center">
          <span className="font-bold">STEAM</span>TRACKER
        </h1>
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label htmlFor="steamId" className="block mb-2">
              Steam ID
            </label>
            <input
              type="text"
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          >
            <img
              src={GithubSVG}
              className="github-logo w-[32px] h-[32px] mt-4"
              alt="GitHub"
            />
          </a>
        </div>
        ...
        <div className="flex flex-row justify-center items-center mt-4">
          <button
            className="btn hover:text-accent text-sm italic bg-transparent border-none hover:bg-transparent font-normal p-0"
